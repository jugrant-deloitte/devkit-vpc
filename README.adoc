...
== Summary
(Note that this needs to be further updated for Deloitte specific information)

This is a fork of the repository at https://github.com/CodeSparta/devkit-vpc
...
- Three Private subnets "no nat to simulate airgapped" (this needs to be fixed in Deloitte environment)
- s3 vpc_endpoint
- ec2 vpc_endpoint
- elb vpc_endpoint
