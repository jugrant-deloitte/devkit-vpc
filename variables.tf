...
variable "aws_ssh_key" {default = "xxx"}
...
variable "aws_secret_key" { default = "xxx" }
...
variable "cluster_name" { default = "xxx" }
...
variable "public_vpc_cidr_block" { default = "10.188.8.0/24" }
variable "private_vpc_cidr_block" { default = "172.15.0.0/24" }
variable "deloitte_subnet_cidr_block"  { default = "10.0.0.0/8" }
